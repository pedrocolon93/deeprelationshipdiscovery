...
from tools import find_in_fasttext, find_in_numberbatch, \
    load_training_input_3, load_training_input_4, find_closest_2
...
class RetroCycleGAN():
    ...
    def load_weights(self):
        try:
            ...
            self.g_AB=load_model("test/toretro.h5")
...
if __name__ == '__main__':
    ...
    rcgan = RetroCycleGAN()
    g_AB = RetroCycleGAN().build_generator(name="toretro")
    g_AB.load_weights("New folder/toretrogen.h5")
    ...
    for idx,word in enumerate(testwords):
        print(word)
        retro_representation = g_AB.predict(fastext_version[idx].reshape(1, 300))
        find_closest_2(retro_representation)
