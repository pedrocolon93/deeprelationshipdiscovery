...
class RetroCycleGAN(nn.Module):
    ...
    def __init__(self, save_index="0", save_folder="./", generator_size=32,
                 ...
                 clip_value=0.5, optimizer="sgd", batch_size=32, dimensionality=300,device="cpu"):
        super().__init__()
                ...
                for batch_i, (imgs_A, imgs_B) in enumerate(load_batch(batch_size, always_random=always_random)):
                    ...
                    if batch_i % 50 == 0:
                        print(
                            ...
                            "MM_ABBA_CYCLE:",mm_abba.item() ,
                            "MM_BAAB_CYCLE:",mm_baab.item() ,
                            "abba acc:",mae_abba.item() ,
                            "baab acc:",mae_baab.item() ,
                            "idloss ab:",mae_id_abba.item() ,
                            "idloss ba:",mae_id_baab.item(),
                            "mm ab loss:",mm_a_loss,
                            "mm ba loss:",mm_b_loss,
                        ...
                        scalars={
                            ...
                            "idloss_ab": mae_id_abba.item(),
                            "idloss_ba": mae_id_baab.item(),
