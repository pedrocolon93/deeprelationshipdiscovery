...
class RetroCycleGAN():
    def __init__(self, save_index = "0"):
        ...
        def create_opt():
            return Adam(lr, clipvalue=cv,clipnorm=cn,amsgrad=True)
...
if __name__ == '__main__':
    ...
    rcgan = RetroCycleGAN()
    X_train, Y_train, X_test, Y_test = rcgan.train(epochs=50, batch_size=4, sample_interval=100,dataset='crawl')
