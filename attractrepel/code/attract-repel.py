...
class ExperimentRun:
    """
    This class stores all of the data and hyperparameters required for an Attract-Repel run-AAAI2020.
    """
    ...
    def attract_repel(self):
        ...
        while current_iteration < self.max_iter:
            ...
            # list of 0 where we run-AAAI2020 synonym batch, 1 where we run-AAAI2020 antonym batch
