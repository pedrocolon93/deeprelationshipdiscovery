...
class VAE():
    def __init__(self, input_dimension=300, output_dimension=300, intermediate_dimension=64, batch_size = 128, latent_dim=64, epochs=50,use_mse = True,intermediate_layer_count = 4):
    ...
    def fit_2(self, X_train, Y_train, X_test, Y_test, weight_filename='vae_mlp_mnist.h5' ):
...
if __name__ == '__main__':
    ...
    output_vae = VAE(intermediate_layer_count=6,latent_dim=64,intermediate_dimension=32,epochs=5)
    output_vae.create_vae()
    output_vae.configure_vae()
    output_vae.compile_vae()
    output_vae.fit_2(X_train, Y_train,X_test,Y_test,"output_vae.h5")
    print(Y_test)
