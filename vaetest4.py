...
from tools import load_training_input_2, load_training_input_3
...
if __name__ == '__main__':
    ...
    X_train, Y_train, X_test, Y_test = load_training_input_3(seed=10)
    ...
    #
    input_vae = VAE(a_weight=1, b_weight=10000, intermediate_layer_count=2, latent_dim=32, intermediate_dimension=512,
                    intermediate_mult = 0.5,
                    epochs=50,loss_weight=1,batch_size=64,lr=0.0005,batch_norm=True,capacity_ratio=100)
    ...
    #
    output_vae = VAE(a_weight=1, b_weight=100, intermediate_layer_count=4, latent_dim=128, intermediate_dimension=512,
                    intermediate_mult = 0.5,
                    epochs=50,loss_weight=0.001,batch_size=8192,lr=0.00005,batch_norm=True,capacity_ratio=10)
