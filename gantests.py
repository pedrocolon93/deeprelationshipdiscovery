...
class DCGAN(object):
    ...
    def discriminator_model(self,lr=0.000008):
        if self.DM:
            return self.DM
    ...
    def adversarial_model(self,lr=0.000005):
        if self.AM:
            return self.AM
...
class RETRO_DCGAN(object):
    def __init__(self):
        ...
        self.discriminator =  self.DCGAN.discriminator_model(lr=0.00001)
        self.adversarial = self.DCGAN.adversarial_model(lr=0.00001)
...
if __name__ == '__main__':
    ...
    load_training_input(100000)
    print("Loaded input")
    retrofit_dcgan = RETRO_DCGAN()
    print("In train")
    retrofit_dcgan.train(train_steps=10000,save_interval=1000,batch_size=128)
    ...
    # retrofit_dcgan.generator.add_loss(["mean_squared_error"])
    retrofit_dcgan.generator.compile(optimizer=Adam(),loss=['mean_squared_error'],metrics=["accuracy"])
    print(y)
    ...
    # print(retrofit_dcgan.generator.)
    print(scores)
    # print(res)