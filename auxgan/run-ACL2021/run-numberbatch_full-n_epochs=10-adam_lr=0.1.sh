...
python ../code/adversarial.py \
    ...
    --out_dir ../results-ACL2021/numberbatch_full-n_epochs=10-adam_lr=0.1/ \
    --n_epochs 10 \
    ...
    --in_embedding_file ../results-ACL2021/numberbatch_full-n_epochs=10-adam_lr=0.1/gold_embs.txt
